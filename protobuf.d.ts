 declare namespace protobuf{
    ...
    module common {
         ...
         */
        function get(file: string): (Imodule|null);
    }
    ...
    class Enum extends ReflectionObject {
         ...
         * @param name Unique name within its module
    ...
    class Field extends FieldBase {
         ...
         * @param name Unique name within its module
         * @param id Unique id within its module
    ...
    class FieldBase extends ReflectionObject {
        ...
        /** Sister-field within the declaring module if an extended field. */
    ...
    /**
     * Loads one or multiple .proto or preprocessed .json files into a common root module and calls the callback.
     * @param filename One or multiple files to load
     * @param root Root module, defaults to create a new one if omitted.
    ...
    /**
     * Loads one or multiple .proto or preprocessed .json files into a common root module and returns a promise.
     * @param filename One or multiple files to load
     * @param [root] Root module, defaults to create a new one if omitted.
     * @returns Promise
     * @see {@link Root#load}
    ...
    /**
     * Synchronously loads one or multiple .proto or preprocessed .json files into a common root module (node only).
     * @param filename One or multiple files to load
     * @param [root] Root module, defaults to create a new one if omitted.
     * @returns Root module
    ...
    class module extends moduleBase {
        ...
        /**
         * Constructs a module from JSON.
         * @param name module name
         * @param json JSON object
         * @returns Created module
         * @throws {TypeError} If arguments are invalid
         */
        public static fromJSON(name: string, json: { [k: string]: any }): module;
    ...
    abstract class moduleBase extends ReflectionObject {

        /** Nested objects by name. */
        public nested?: { [k: string]: ReflectionObject };

        /** Nested objects of this module as an array for iteration. */
        public readonly nestedArray: ReflectionObject[];

        /**
         * Converts this module to a module descriptor.
         * @param [toJSONOptions] JSON conversion options
         * @returns module descriptor
         */
        public toJSON(toJSONOptions?: IToJSONOptions): Imodule;

        /**
         * Adds nested objects to this module from nested object descriptors.
         * @param nestedJson Any nested object descriptors
         * @returns `this`
         */
        public addJSON(nestedJson: { [k: string]: AnyNestedObject }): module;
         ...
         * This methods differs from {@link module#get|get} in that it returns an enum's values directly and throws instead of returning `null`.
        ...
        /**
         * Adds a nested object to this module.
         * @param object Nested object to add
         * @returns `this`
         * @throws {TypeError} If arguments are invalid
         * @throws {Error} If there is already a nested object with this name
         */
        public add(object: ReflectionObject): module;

        /**
         * Removes a nested object from this module.
         * @param object Nested object to remove
         * @returns `this`
         * @throws {TypeError} If arguments are invalid
         * @throws {Error} If `object` is not a member of this module
         */
        public remove(object: ReflectionObject): module;

        /**
         * Defines additial modules within this one if not yet existing.
         * @param path Path to create
         * @param [json] Nested types to create from JSON
         * @returns Pointer to the last module created or `this` if path is empty
         */
        public define(path: (string|string[]), json?: any): module;

        /**
         * Resolves this module's and all its nested objects' type references. Useful to validate a reflection tree, but comes at a cost.
         * @returns `this`
         */
        public resolveAll(): module;

        /**
         * Recursively looks up the reflection object matching the specified path in the scope of this module.
        ...
        /**
         * Looks up the reflection object at the specified path, relative to this module.
         * @param path Path to look up
        ...
        /**
         * Looks up the {@link Type|type} at the specified path, relative to this module.
         * Besides its signature, this methods differs from {@link module#lookup|lookup} in that it throws instead of returning `null`.
         * @param path Path to look up
        ...
        /**
         * Looks up the values of the {@link Enum|enum} at the specified path, relative to this module.
         * Besides its signature, this methods differs from {@link module#lookup|lookup} in that it throws instead of returning `null`.
         * @param path Path to look up
        ...
        /**
         * Looks up the {@link Type|type} or {@link Enum|enum} at the specified path, relative to this module.
         * Besides its signature, this methods differs from {@link module#lookup|lookup} in that it throws instead of returning `null`.
         * @param path Path to look up
        ...
        /**
         * Looks up the {@link Service|service} at the specified path, relative to this module.
         * Besides its signature, this methods differs from {@link module#lookup|lookup} in that it throws instead of returning `null`.
         * @param path Path to look up
    ...
    type AnyNestedObject = (IEnum|IType|IService|AnyExtensionField|Imodule);
    ...
    /** Root module wrapping all types, enums, services, sub-modules etc. that belong together. */
    class Root extends moduleBase {

        /**
         * Constructs a new root module instance.
        ...
        /**
         * Loads a module descriptor into a root module.
         * @param json Nameespace descriptor
         * @param [root] Root module, defaults to create a new one if omitted
         * @returns Root module
         */
        public static fromJSON(json: Imodule, root?: Root): Root;
        ...
        /**
         * Loads one or multiple .proto or preprocessed .json files into this root module and calls the callback.
        ...
        /**
         * Loads one or multiple .proto or preprocessed .json files into this root module and returns a promise.
         * @param filename Names of one or multiple files to load
         * @param [options] Parse options. Defaults to {@link parse.defaults} when omitted.
         * @returns Promise
         */
        ...
        /**
         * Synchronously loads one or multiple .proto or preprocessed .json files into this root module (node only).
         * @param filename Names of one or multiple files to load
         * @param [options] Parse options. Defaults to {@link parse.defaults} when omitted.
         * @returns Root module
         * @throws {Error} If synchronous fetching is not supported (i.e. in browsers) or if a file's syntax is invalid
    ...
    class Type extends moduleBase {
        ...
        /** Oneofs declared within this module, if any. */
    ...
    interface IType extends Imodule {
